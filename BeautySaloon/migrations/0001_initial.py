    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(max_length=200, unique=True, verbose_name='Уникальная часть url')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tip', models.DecimalField(blank=True, decimal_places=2, max_digits=8, null=True, validators=[django.core.validators.MinValueValidator(1)], verbose_name='Чаевые')),
                ('question', models.TextField(blank=True, default=None, null=True, verbose_name='Вопрос к заказу')),
                ...
                ('review', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='orders', to='BeautySaloon.review', verbose_name='Отзыв')),
